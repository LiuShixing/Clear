...
void SkinnedData::AddAnimtion(std::string& clipName, AnimationClip& animationClip)
{
	mAnimations[clipName] = animationClip;
}
void SkinnedData::SetBoneHierarchy(std::vector<int>& boneHierarchy)
{
	mBoneHierarchy = boneHierarchy;
}
void SkinnedData::SetBoneOffset(int boneIndex,XMFLOAT4X4& Moffset)
{
	mBoneOffsets[boneIndex]=Moffset;
}
void SkinnedData::SetBoneOffsetCount(int boneCount)
{
