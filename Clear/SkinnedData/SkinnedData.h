...
public:
	...
	void AddAnimtion(std::string& clipName, AnimationClip& animationClip);
	void SetBoneHierarchy(std::vector<int>& boneHierarchy);
	void SetBoneOffset(int boneIndex, XMFLOAT4X4& Moffset);
	void SetBoneOffsetCount(int boneCount);
